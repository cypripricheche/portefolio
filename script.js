...
const connectAlert = document.getElementById("connect-alert");
const cancelBtn = document.querySelector("#connect-alert input[value='Annuler']");
const loginBtn = document.querySelector("#connect-alert input[value='Se connecter']");
const usernameInput = document.getElementById("username");
const passwordInput = document.getElementById("password");

connectBtn.addEventListener("click", () => {
  connectAlert.style.display = "flex";
});
